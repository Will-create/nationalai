...
def get_ds(config):
    ds_raw = load_dataset('louisbertson', f'{config['lang_src']}_{config['lang_tgt']}', split='train')
    ...
    train_ds = BilingualDataset(train_ds_raw, tokenizer_src, tokenizer_tgt, config['lang_srt'], config['lang_tgt'], config['seq_len'])
    val_ds = BilingualDataset(val_ds_raw, tokenizer_src, tokenizer_tgt, config['lang_srt'], config['lang_tgt'], config['seq_len'])
